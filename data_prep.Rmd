...
output:
    ...
    # Si export en word (et dans ce cas supprimer les lignes dédiées à l'export html)
       reference_doc: css/stylesCybergeo.doc
...
# Mots-clés
La revue a créé un index des mots clés en français et en anglais : https://journals-openedition-org.ezproxy.u-paris.fr/cybergeo/33

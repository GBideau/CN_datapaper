...
La partie 5 présente l'ensemble des données disponibles aux géographies du 1er janvier 2011 (`df2011`) et celles du 1er janvier de la dernière année disponible (`df_new`). 
...
## 3.1 - Préparation des données statistiques
...
## 3.2 - Données concernant les fusions communales et les communes nouvelles
...
### 3.2.1 - Identification des communes fusionnantes
...
### 3.2.2 - Identification et caractérisation des communes nouvelles
...
### 3.2.3 - Gestion des scissions communales
...
## 3.3 - Agrégation des indicateurs en version la plus récente et calcul des ratios
...
## 3.4 - Résumé des indicateurs disponibles par fichier de données de référence
...
## 3.5 - Agrégation des dernières géométries connues (2021), extraction des communes nouvelles et export des résultats
